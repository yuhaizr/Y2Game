	...
	<div class="col-xs-12 col-md-12">
	    	<div class="widget">
	       	<div class="widget-header ">
	           	<span class="widget-caption">行政区列表</span>
	            ...
	            <div class="widget-body">
	                ...
	                <table class="table table-striped table-bordered table-hover" id="simpledatatable">
	                   ...
	                   <tbody id="activityNoticeListTable">
	                   		<?php if(is_array($activityNoticeList)): foreach($activityNoticeList as $key=>$vo): ?><tr>
	                   				<td><?php echo ($key+1); ?></td>
	                   				<td><?php echo ($vo["ctime"]); ?></td>
	                   				<td><?php echo ($vo["mtime"]); ?></td>
	                   				<td><?php echo ($vo["districtno"]); ?></td>
	                   				<td><?php echo ($vo["districtname"]); ?></td>
	                   				<td>
	                   					<a class=''>删除</a>
	                   				</td>
