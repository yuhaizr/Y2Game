                             ...
                             <form id="registrationForm" action="/jjtrqgl/index.php/Home/User/useredit?id=2" method="post" class="form-horizontal bv-form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" novalidate="novalidate">
                                 ...
                                 <div class="form-group has-feedback">
                                     ...
                                     <div class="col-lg-4">
                                         ...
                                         value = "<?php echo ($userinfo["account"]); ?>"
                                         disabled
                                         >
                                     </div>
                                 </div>
                                 <!-- 
                                 <div class="form-group has-feedback">
                                     <label class="col-lg-4 control-label">原　密  码</label>
                                     <div class="col-lg-4">
                                  ...
                                  -->
                                 <div class="form-group has-feedback">
                                     <label class="col-lg-4 control-label">新　密  码</label>
                                     <div class="col-lg-4">
                                         <input type="text" class="form-control" name="password" 
                                         data-bv-notempty="true" 
                                         data-bv-notempty-message="The username is required and cannot be empty" 
                                 ...
                                 <div class="form-group has-feedback">
                                     ...
                                     <div class="col-lg-4">
                                         <input type="text" class="form-control" name="remark" data-bv-notempty="true" data-bv-notempty-message="The password is required and cannot be empty"  data-bv-field="password" value = "<?php echo ($userinfo["remark"]); ?>">
                                     </div>
                                 </div>
