        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a id="editabledatatable_new" href="/fundcrm/index.php/Home/Role/roleAdd" class="btn btn-default" >
                        Add New Role
                    </a>
                ...
                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                    ...
                    <tbody>
						<?php if(is_array($roleinfolist)): foreach($roleinfolist as $key=>$value): ?><tr>
								...
								<td>
                               	<a href="/fundcrm/index.php/Home/Role/roleEdit?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a>
                               	<a href="/fundcrm/index.php/Home/Role/roleAuth?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 授权</a>
                                <a href="/fundcrm/index.php/Home/Role/roleUserList?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 用户列表</a>
