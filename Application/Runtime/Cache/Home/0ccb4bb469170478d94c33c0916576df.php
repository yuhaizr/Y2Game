...
<head>
	...
	var __URL = '/jjtrqgl/index.php/Home/Log';
...
<link href="/jjtrqgl/Public/css/bootstrap-datetimepicker.css" rel="stylesheet" />
            	...
            	<div class="table-toolbar ">
			            		...
			            		<div class = "col-sm-4">
				                		...
				                		<div style="display: inline;">        			
				                			<span class="input-icon">
				                				<input type="text" value="<?php echo ($searchNickname); ?>" class="form-control" id="searchNickname" placeholder="请输入用户名">
				                    ...
				                    <div class="form-group">
				                        <div class="controls">
				                            <div class="input-group">
				                                ...
				                                <input type="text" value="<?php echo ($searchTime); ?>" class="form-control" id="searchTime" placeholder="请选择时间区间" />
				                            </div>
				                        </div>
				                    </div> 
			                	</div>	
          		...
          		<table class="table table-striped table-hover table-bordered" id="editabledatatable">
                    ...
                    <tbody id="logListTable">
                    	<?php if(is_array($logList)): foreach($logList as $key=>$vo): ?><tr>
                            ...
                            <td><abbr title=<?php echo ($vo["parameter"]); ?>><?php echo (get30char($vo["parameter"])); ?></abbr></td>
...
<script src="/jjtrqgl/Public/js/datetime/bootstrap-datepicker.js"></script>
<script src="/jjtrqgl/Public/js/datetime/bootstrap-timepicker.js"></script>
<script src="/jjtrqgl/Public/js/datetime/bootstrap-datetimepicker.js"></script>

<!--Beyond Scripts-->
<script src="/jjtrqgl/Public/js/beyond.min.js"></script>
<script src="/jjtrqgl/Public/js/datetime/moment.js"></script>
<script src="/jjtrqgl/Public/js/datetime/daterangepicker.js"></script>
<script type="text/javascript">
...
$("#search").click(function(){
	...
	$.ajax({
		url:"/jjtrqgl/index.php/Home/Log/logList",
		type:"GET",
		data:data,
		dataType:'json',
		success:function(data){
