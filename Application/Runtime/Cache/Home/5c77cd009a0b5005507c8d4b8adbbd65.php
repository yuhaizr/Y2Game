...
<head>
	...
	var __URL = '/Y2Game/index.php/Home/Role';
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                	...
                                	<?php if(is_array($taskList)): foreach($taskList as $key=>$vo): ?><li data-url="<?php echo ($vo["url"]); ?>" data-id="<?php echo ($vo["id"]); ?>" class='read_message'>
                                   		...
                                   		<li style="font-size: 0.2em;text-align: right;">
                                			<a href="/Y2Game/index.php/Home/Task/taskList" target="_blank">
                                				<span >
                                					显示所有消息
                                				</span>
                                			</a>
                    ...
                    <?php if(is_array($menu)): foreach($menu as $key=>$value): ?><li  <?php if($value["link"] == $NOW_MENU): ?>class='open'<?php endif; ?>  >
                        	...
                        	<ul class="submenu">
                        		<?php if(is_array($value["childs"])): foreach($value["childs"] as $key=>$v): ?><li   <?php if($v["link"] == $SECOND_NOW_MENU): ?>class='open'<?php endif; ?> >
                        				<?php if(empty($v["childs"])): ?><a href="/Y2Game/index.php<?php echo ($v["link"]); ?>" target="_blank">
		                               	...
		                               	<?php else: ?>
				                            ...
				                            <ul class="submenu">
				                                <?php if(is_array($v["childs"])): foreach($v["childs"] as $key=>$cv): ?><li>
						                                	  <a href="/Y2Game/index.php<?php echo ($cv["link"]); ?>" target="_blank">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="table-toolbar">
                    <a id="editabledatatable_new" href="/Y2Game/index.php/Home/Role/roleAdd" class="btn btn-default" >添加角色</a>
                ...
                <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                    ...
                    <tbody>
						<?php if(is_array($roleinfolist)): foreach($roleinfolist as $key=>$value): ?><tr>
								...
								<td>
                               	<a href="/Y2Game/index.php/Home/Role/roleEdit?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a>
                               	<a href="/Y2Game/index.php/Home/Role/roleAuth?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 授权</a>
                                <a href="/Y2Game/index.php/Home/Role/roleUserList?id=<?php echo ($value["id"]); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 用户列表</a>
                                <a href="/Y2Game/index.php/Home/Role/roleDel?id=<?php echo ($value["id"]); ?>" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 删除</a>
                            </td>
