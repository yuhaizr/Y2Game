...
<head>
	...
	var __URL = '/fundcrm/index.php/Hefm/Order';
                 ...
                 <div class="col-lg-6 col-sm-6 col-xs-12">
                     <div class="widget radius-bordered">
                         ...
                         <div class="widget-body">
                             <form id="orderInfo" class="form-horizontal bv-form">
							<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
                                 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" class="form-control" name="custname" id="custname" placeholder="客户姓名" value="<?php echo ($data["custname"]); ?>">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
											 <label><input type="radio" name="sex" value="0" <?php echo ($data['sex'] == '0' ? 'checked="checked"' : ''); ?> /><span class="text">女士</span></label>
											 <label><input type="radio" name="sex" value="1" <?php echo ($data['sex'] == '1' ? 'checked="checked"' : ''); ?>/><span class="text">先生</span></label>
											 <span class="text"></span></div>
										</div>
									</div>
								 </div>
								 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                             <input type="text" class="form-control" name="mobileno" id="mobileno" placeholder="电话"  value="<?php echo ($data["mobileno"]); ?>"><span class="text"></span></div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <input type="text" class="form-control" value="<?php echo (getOrderStatus($data["status"])); ?>" readonly="readonly"></div>
										</div>
									</div>
								 </div>
								 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <select id="e1" name="product_type" style="width:100%">
												<?php if(is_array($producttype)): foreach($producttype as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php echo ($producttype_select[$vo['id']]); ?>/><?php echo ($vo["typename"]); endforeach; endif; ?>
											</select>
											<span class="text"></span></div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <select id="e2" name="product_id" style="width:100%">
												<?php if(is_array($products)): foreach($products as $key=>$vo): ?><option value="<?php echo ($vo["productcode"]); ?>"<?php echo ($product_select[$vo['id']]); ?>/><?php echo ($vo["productname"]); endforeach; endif; ?>
											</select>
											<span class="text"></span></div>
										</div>
									</div>
								 ...
								 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                             <input type="text" class="form-control" name="amount" id="amount" placeholder="购买金额" value="<?php echo ($data["amount"]); ?>">
											 <span class="text"></span></div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label class="col-lg-4 control-label">所属销售</label>
											<div class="col-lg-8">
                                             <input type="text" class="form-control" placeholder="所属销售" readonly="readonly" value="<?php echo ($data["nickname"]); ?>">
											</div>
										</div>
									</div>
								 </div>
								 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label class="col-lg-4 control-label">订单优先级</label>
											<div class="col-lg-8">
											<input type="text" class="form-control" placeholder="订单优先级" readonly="readonly" value="<?php echo (getOrderLevel($data["orderlevel"])); ?>"></div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <input type="text" class="form-control" name="identitycard" id="identitycard" placeholder="身份证" value="<?php echo ($data["identitycard"]); ?>">
											<span class="text"></span></div>
										</div>
									</div>
								 </div>
								 ...
								 <div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <input type="text" class="form-control" name="address" id="address" placeholder="联系地址" value="<?php echo ($data["address"]); ?>">
											<span class="text"></span></div>
										</div>
									</div>
								 </div>
								 <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <input type="text" class="form-control" name="zipcode" id="zipcode" placeholder="邮编" value="<?php echo ($data["zipcode"]); ?>">
											<span class="text"></span></div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-lg-8">
                                            <input type="text" class="form-control" placeholder="预约时间" readonly="readonly" value="<?php echo ($data["ctime"]); ?>" >
											</div>
										</div>
									</div>
								 </div>								 
                                <div class="row">
									<div class="form-group">
                                      <div class="col-lg-8 col-lg-offset-4">
                                         <?php if($checkupdate == true): ?><input class="btn btn-palegreen" type="button" id="orderinfo_save" value="更 新"><?php endif; ?>
					...
					<!-- order record -->
					<?php if($checkrecord == true): ?><div class="col-lg-6 col-sm-6 col-xs-12">
					<div class="widget  radius-bordered">
						<div class="widget-header">
							<span class="widget-caption">销售记录</span>
						</div>
						<div class="widget-body">
							<div class="docs-example">
								<ul class="nav nav-tabs tabs-flat">
									<li class="active"><a href="#info-tab" data-toggle="tab">新增记录</a></li>
									<li class=""><a href="#address-tab" data-toggle="tab">历史记录</a></li>
								</ul>
								
									<div class="tab-content tabs-flat">
										<div class="tab-pane active" id="info-tab">
										<form id="record_form" action="/fundcrm/index.php/Hefm/Order/record" method="post" class="form-horizontal bv-form" novalidate="novalidate">
										<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
											<div class="form-group has-feedback">
												<label class="col-lg-4 control-label">订单优先级</label>
												<div class="col-lg-8">
													<select id="e3" name="orderlevel" style="width:100%">
														<?php if(is_array($orderlevels)): foreach($orderlevels as $k=>$vo): ?><option value="<?php echo ($k); ?>"<?php echo ($levels_select[$k]); ?>/><?php echo ($vo); endforeach; endif; ?>
													</select>
												</div>
											</div>
											<div class="form-group has-feedback">
												<label class="col-lg-4 control-label">订单状态</label>
												<div class="col-lg-8">
													<select id="e4" name="orderstatus" style="width:100%">
														<?php if(is_array($order_status)): foreach($order_status as $k=>$vo): ?><option value="<?php echo ($k); ?>"<?php echo ($levels_select[$k]); ?>/><?php echo ($vo); endforeach; endif; ?>
													</select>
												</div>
											</div>
											<div class="form-group has-feedback">
												<label class="col-lg-4 control-label">订单备注</label>
												<div class="col-lg-8">
												...
												<div class="form-group">
												<div class="col-lg-8 col-lg-offset-4">
													<button type="button" id="record_save" class="btn btn-blue">保存</button>
													<span class="text"></span>
												</div>
											</div>
										</form>
										...
										<div class="tab-pane" id="address-tab">
											<table class="table table-striped table-bordered table-hover" id="expandabledatatable">
												...
												<tbody>
													<?php if(is_array($record_list)): foreach($record_list as $key=>$vo): ?><tr>
														<td><?php echo ($vo["id"]); ?></td>
														<td><?php echo ($vo["nickname"]); ?></td>
														<td><?php echo (getOrderStatus($vo["orderstatus"])); ?></td>
														<td><?php echo (getOrderLevel($vo["orderlevel"])); ?></td>
...
<script src="/fundcrm/Public/js/datatable/jquery.dataTables.min.js"></script>
...
$(document).ready(function () {
	...
	$("#e1").change(function(){
		$.ajax({
			type: "POST",
			url: '/fundcrm/index.php/Hefm/Order/orderinfo?id=27',
			data: "method=getproductlistbytype&type=" + $(this).val(),
			dataType: 'json',
			success: function(dt) {
				$("#e2").empty();
				if(dt){
					$.each(dt,function(i,n){
						$("#e2").append('<option value="'+n.productcode+'">'+n.productname+'</option>');
					});
					$("#e2").select2("val", "");
				}
				$("#e2").change();
...
$("#orderinfo_save").click(function(){
	var dt = $("#orderInfo").serialize();
	$(this).attr('disabled','disabled');
	$(this).next('span').html("Saving...");
	$.ajax({
		type: "POST",
		url: '/fundcrm/index.php/Hefm/Order/update',
		data: dt,
		dataType: 'json',
		success: function(dt) {
			if(dt) {								
				$("#orderinfo_save").next('span').html(dt.message);
			}
			
			$("#orderinfo_save").removeAttr('disabled');
		}
	});
});
$("#record_save").click(function(){
	var orderstatus = $("#e4").val();
	var remark = $("#remark").val();
	if(remark == "" && (orderstatus == 10 || orderstatus == 12)) {
		alert('备注信息不能为空');
		return false;
	}
	
	if(!confirm('请确保订单信息已经保存')){
		return false;
	}
	$(this).attr('disabled','disabled');
	$(this).next('span').html("Saving...");
